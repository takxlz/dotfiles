...
if dein#load_state(s:dein_dir)
    ...
    " call dein#load_toml(s:toml_dir . '/on/' . 'mattn@vim-lsp-settings.toml', {'lazy': 0})
    ...
    call dein#load_toml(s:toml_dir . '/lazy/' . 'neoclide@coc.nvim.toml', {'lazy': 1})
    call dein#load_toml(s:toml_dir . '/lazy/' . 'kristijanhusak@defx-git.toml', {'lazy': 1})
    " call dein#load_toml(s:toml_dir . '/lazy/' . 'dense-analysis@ale.toml', {'lazy': 1})
